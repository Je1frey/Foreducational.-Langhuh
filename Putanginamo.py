...
def check_proxy(proxy):
      ...
      try:
        ...
        r = requests.get('<a href="https://www.wikipedia.org',proxies=proxies" rel="nofollow">https://www.wikipedia.org',proxies=proxies</a>, timeout=5)
...
def cnet():
    ...
    try:
        ...
        socket.create_connection((socket.gethostbyname("<a href="http://www.google.com" rel="nofollow">www.google.com</a>"), 80), 2)
...
def login(self,target, password):
    ...
    try:
        ...
        self.br.open("<a href="https://facebook.com" rel="nofollow">https://facebook.com</a>")
